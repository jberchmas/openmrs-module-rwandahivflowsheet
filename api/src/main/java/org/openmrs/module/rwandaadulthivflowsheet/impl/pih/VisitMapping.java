...
import org.openmrs.module.rwandaadulthivflowsheet.mapper.Visit;
...
public class VisitMapping extends ObsMapping implements Comparable<VisitMapping>, Visit {
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getDate()
	 */
	@Override
	public Date getDate() {
...
//		}
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getWeight()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getOI()
	 */
	@Override
	public Obs getOI() {
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getSTI()
	 */
	@Override
	public Obs getSTI() {
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getTBScreening()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getFamilyPlanning()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getPregnancyStatus()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getNumberOfMissedDosesInThePastMonth()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getCreat()
	 */
	@Override
	public Obs getCreat() {
	...
	/* (non-Javadoc)
	 * @see org.openmrs.module.rwandaadulthivflowsheet.web.controller.VisitMapper#getReasonForPoorAdherenceToAntiRetoroviralTherapy()
	 */
	@Override
